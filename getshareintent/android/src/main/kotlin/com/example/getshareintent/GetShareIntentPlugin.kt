...
class GetShareIntentPlugin:
  ...
  override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
    if (call.method == "getShareIntent" && currentShare != null) {
  ...
  private fun setupChannels(messenger : BinaryMessenger, context : Context) {
    methodChannel = MethodChannel(messenger, "plugins.flutter.io/getshareintent")
    eventChannel = EventChannel(messenger, "plugins.flutter.io/getshareintent_status")
